...
export const initialState: IAssetListState = {
  [AssetType.Ethereum]: {
    ...
    native: true,
    network: 'both',
    logo: 'https://lattice-exchange-assets.s3.amazonaws.com/stargazer_simplex/ethereum-logo.png',
    priceId: 'ethereum',
    decimals: 18,
  },
  [AssetType.Constellation]: {
    ...
    native: true,
    network: 'both',
    logo: 'https://lattice-exchange-assets.s3.amazonaws.com/stargazer_simplex/constellation-logo.png',
  ...
  '0xa393473d64d2F9F026B60b6Df7859A689715d092': {
    ...
    network: 'mainnet',
    logo: 'https://lattice-exchange-assets.s3.amazonaws.com/stargazer_simplex/lattice-logo.png',
    decimals: 8,
  },
