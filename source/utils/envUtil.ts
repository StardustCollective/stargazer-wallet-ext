...
export const QUICKNODE_ETHEREUM_ROPSTEN = process.env.QUICKNODE_ETHEREUM_ROPSTEN;
export const QUICKNODE_ETHEREUM_RINKEBY = process.env.QUICKNODE_ETHEREUM_RINKEBY;
