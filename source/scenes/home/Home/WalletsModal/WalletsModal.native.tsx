        ...
        <>
          ...
          </TextV3.Caption>
          {
            multiChainWallets.map((wallet, i) => {
              ...
              return (
                <TouchableOpacity key={i} onPress={() => handleSwitchWallet(wallet.id, wallet.accounts)}>
                  <View style={walletStyles}>
                    ...
                    <View testID={wallet.label} style={styles.walletInfoContainer}>
                      <View style={styles.walletLabelContainer}>
                        ...
                        <TextV3.Caption dynamic color={COLORS_ENUMS.GRAY_100}>Multi-Chain Wallet</TextV3.Caption>
                      </View>
                  ...
                  <View style={walletStyles}>
                    ...
                    <View testID={wallet.label} style={styles.walletInfoContainer}>
                      <View style={styles.walletLabelContainer}>
                        ...
                        <TextV3.Caption dynamic color={COLORS_ENUMS.GRAY_100}>{ellipsis(wallet.accounts[0].address)}</TextV3.Caption>
                      </View>
                      {renderCheckIcon(wallet.id, activeWallet.id)}
                    </View>
                  </View>
