...
import Browser from 'scenes/home/Browser';
...
const BrowserTab = () => {
  return (
    ...
    >
      {/* Browser Stack */}
      <Stack.Screen name={screens.authorized.browser} component={Browser} />
    </Stack.Navigator>
  );
}
...
const Tabs = () => {
  return (
    <Tab.Navigator tabBarOptions={{ showLabel: false }}>
      <Tab.Screen 
        options={{ tabBarIcon: ({ focused }) => <WalletIcon height={24} width={24} color={focused ? '#781FFF' : '#6F6F70'} /> }} 
        name={screens.tabs.home} 
        component={HomeTab} 
      />
      <Tab.Screen 
        options={{ tabBarIcon: ({ focused }) => <GlobeIcon height={24} width={24} color={focused ? '#781FFF' : '#6F6F70'} /> }} 
        name={screens.tabs.browser} 
        component={BrowserTab} 
      />
      <Tab.Screen 
        options={{ tabBarIcon: ({ focused }) => <SettingsIcon height={24} width={24} color={focused ? '#781FFF' : '#6F6F70'} /> }} 
